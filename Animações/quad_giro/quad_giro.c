...
<CodeBlocks_project_file>
	...
	<Project>
		<Option title="quad_giro" />
		<Option pch_mode="2" />
		<Option compiler="gcc" />
		<Build>
			<Target title="Debug">
				<Option output="bin/Debug/quad_giro" prefix_auto="1" extension_auto="1" />
			...
			<Target title="Release">
				<Option output="bin/Release/quad_giro" prefix_auto="1" extension_auto="1" />
				<Option working_dir="C:/Program Files (x86)/CodeBlocks/MinGW/bin" />
